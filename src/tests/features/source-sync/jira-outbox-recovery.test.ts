...
import type { ExternalActionRequest } from "../../../entities/work-context/api/external-action-repository";
import type { JiraTransitionPreview } from "../../../features/sources/jira-transition";
import {
  externalActionErrorCategory,
  recoverJiraOutbox,
} from "../../../features/sources/jira-outbox-recovery";
import { jiraPreviewToExternalActionInput } from "../../../features/sources/jira-outbox-safety";
