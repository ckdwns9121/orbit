ALTER TABLE work_item_links RENAME TO work_item_links_v16;
...
CREATE TABLE work_item_links (
  ...
  kind TEXT NOT NULL CHECK (kind IN ('jira', 'github_pr', 'github_commit', 'slack')),
  external_id TEXT,
  external_url TEXT,
  label TEXT NOT NULL,
...
FROM work_item_links_v16;

DROP TABLE work_item_links_v16;
