...
- Evidence reviewed:
  ...
  - Orca의 `src/renderer/src/assets/main.css`와 패널형 데스크톱 UI를 시각 참고 자료로 사용
...
- Primary navigation: Planner, Task, Calendar, Workspace, Tickets, Chat; 보조 영역으로 Graph와 Settings
- Core routes/screens:
...
- Spacing/layout rhythm: 4px 기준 단위, 일반 간격 8/12/16/24px. 데스크톱 기본은 좌측 sidebar + 중앙 workspace + 선택적 우측 inspector 구조다.
